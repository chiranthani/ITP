...
public class courseReport extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String query = "select c.courseName,c.courseCode,s.subName,s.subCode\n" +
"from course c, subject s,student st\n" +
"group by c.courseCode,s.subCode";

            String reportPath = "C:\\Users\\jahrin\\Documents\\NetBeansProjects\\IMS Progress V 6\\src\\java\\reports\\course.jrxml";
